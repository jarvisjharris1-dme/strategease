        ...
        >
          <div>
            ...
            <p style={{ marginTop: 18, fontSize: 14.5, lineHeight: 1.6, maxWidth: 300, color: 'var(--muted-on-ink)' }}>
              Helping leaders <span style={{ color: '#ffffff' }}>SEE</span> the system. <span style={{ color: '#ffffff' }}>ALIGN</span> the organization. <span style={{ color: '#ffffff' }}>DELIVER</span> measurable outcomes.
            </p>
